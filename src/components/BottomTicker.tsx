...
export default function BottomTicker({ fixedPosition = true }: BottomTickerProps) {
  ...
  return (
    <div className={`${fixedPosition ? 'fixed bottom-0' : 'relative'} left-0 right-0 w-full md:w-screen h-16 text-black uppercase tracking-[0.12em] text-4xl md:text-5xl overflow-hidden pointer-events-none flex items-center z-10`}>
